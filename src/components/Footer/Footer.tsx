...
const Footer = () => {
  ...
  return (
    <footer id="footer" className="bg-primary-dark text-gray-100 pt-4 pb-6">
      <div className="flex flex-col items-center mx-auto px-5">
        <div className="relative w-full flex items-center justify-center my-6">
          <div className="h-[4px] w-2/3 rounded-full bg-gradient-to-r from-transparent via-white to-transparent"></div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <p className="text-xs text-center font-semibold">{t("footer.copyrightText")}</p>
        </div>
      </div>
    </footer>
  );
